#!/usr/bin/env python
# -*- coding: utf-8 -*-
# Modified from https://github.com/twilsonco/latexdiffcite
...
class Config(object):
    ...
    def load_defaults():
        ...
        Config.latexdiff_args = append_args
...
def run_latexdiff(file1, file2):
    ...
    #args_str = 'latexdiff %s %s %s' % (Config.latexdiff_args, file1, file2)
    with io.open(Files.out_path, 'w', encoding='utf-8') as f:
        # https://stackoverflow.com/questions/2400878/why-subprocess-popen-doesnt-work-when-args-is-sequence
        #process = subprocess.Popen(args_str, shell=True, stdout=f, stderr=subprocess.PIPE)
